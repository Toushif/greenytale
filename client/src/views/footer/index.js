                ...
                <div className="container bottom_border">
                    <div className="row">
                        <div className=" col-sm-4 col-md col-sm-4  col-12 col">
                            ...
                            <p><i className="fa fa-location-arrow"></i>   Kolkata, India</p>
                            <p><i className="fa fa-phone"></i>  +91-8981288955  </p>
                            <p><i className="fa fa fa-envelope"></i> produce.recycle@gmail.com  </p>
